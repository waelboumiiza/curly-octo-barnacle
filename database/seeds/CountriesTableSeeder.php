...
class CountriesTableSeeder extends Seeder
{
    	...
    	public function run() 
	{
		...
		$countries = array(
			...
			array('code' => 'SO', 'Somalia'),
			array('code' => 'ZA', 'South Africa'),
			array('code' => 'GS', 'South Georgia South Sandwich Islands'),
			array('code' => 'ES', 'Spain'),
			array('code' => 'LK', 'Sri Lanka'),
			array('code' => 'SH', 'St. Helena'),
			array('code' => 'PM', 'St. Pierre and Miquelon'),
			array('code' => 'SD', 'Sudan'),
			array('code' => 'SR', 'Suriname'),
			array('code' => 'SJ', 'Svalbarn and Jan Mayen Islands'),
			array('code' => 'SZ', 'Swaziland'),
			array('code' => 'SE', 'Sweden'),
			array('code' => 'CH', 'Switzerland'),
			array('code' => 'SY', 'Syrian Arab Republic'),
			array('code' => 'TW', 'Taiwan'),
			array('code' => 'TJ', 'Tajikistan'),
			array('code' => 'TZ', 'Tanzania, United Republic of'),
			array('code' => 'TH', 'Thailand'),
			array('code' => 'TG', 'Togo'),
			array('code' => 'TK', 'Tokelau'),
			array('code' => 'TO', 'Tonga'),
			array('code' => 'TT', 'Trinidad and Tobago'),
			array('code' => 'TN', 'Tunisia'),
			array('code' => 'TR', 'Turkey'),
			array('code' => 'TM', 'Turkmenistan'),
			array('code' => 'TC', 'Turks and Caicos Islands'),
			array('code' => 'TV', 'Tuvalu'),
			array('code' => 'UG', 'Uganda'),
			array('code' => 'UA', 'Ukraine'),
			array('code' => 'AE', 'United Arab Emirates'),
			array('code' => 'GB', 'United Kingdom'),
			array('code' => 'UM', 'United States minor outlying islands'),
			array('code' => 'UY', 'Uruguay'),
			array('code' => 'UZ', 'Uzbekistan'),
			array('code' => 'VU', 'Vanuatu'),
			array('code' => 'VA', 'Vatican City State'),
			array('code' => 'VE', 'Venezuela'),
			array('code' => 'VN', 'Vietnam'),
			array('code' => 'VG', 'Virigan Islands (British)'),
			array('code' => 'VI', 'Virgin Islands (U.S.)'),
			array('code' => 'WF', 'Wallis and Futuna Islands'),
			array('code' => 'EH', 'Western Sahara'),
			array('code' => 'YE', 'Yemen'),
			array('code' => 'YU', 'Yugoslavia'),
			array('code' => 'ZR', 'Zaire'),
			array('code' => 'ZM', 'Zambia'),
			array('code' => 'ZW', 'Zimbabwe'),
		);
